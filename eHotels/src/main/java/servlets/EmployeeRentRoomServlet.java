...
@WebServlet("/employeeRentRoom")
public class EmployeeRentRoomServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String payment_info = request.getParameter("payment_info");  // new payment info field

        // SQL to insert into renting table with payment_info
        ...
        try (Connection con = db.getConnection();
            ...
            // Redirect to success page after successful renting creation
            response.sendRedirect("rentingsuccess.jsp");
        } catch (Exception e) {
